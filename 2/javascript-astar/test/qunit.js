        ...
        if (toolbar) {
            ...
            if (numModules > 1) {
                ...
                addEvent(moduleFilter.lastChild, "change", function () {
                    var selectBox =
                            moduleFilter.getElementsByTagName("select")[0],
                    ...
                    window.location = QUnit.url({
                        module:
                            selectedModule === "" ? undefined : selectedModule,
    ...
    Test.prototype = {
        ...
        setup: function () {
            ...
            if (config.notrycatch) {
                this.testEnvironment.setup.call(
